...
const AddQueries = () => {
  ...
  const handleAddQueries = (e) => {
    ...
    axios
      .post(
        "https://b10-a11-server-side-shbhuiyan-main.vercel.app/queries",
        newQueries
      )
      .then((res) => {
      ...
      <form onSubmit={handleAddQueries}>
        ...
        <div className="mb-4">
          <label
            ...
            className="block text-sm font-medium text-gray-700 mb-2"
          >
            Query Title <span className="text-red-600">*</span>
          </label>
          <input
            type="text"
            id="queryTitle"
        ...
        <div className="mb-4">
          <label
            ...
            className="block text-sm font-medium text-gray-700 mb-2"
          >
            Boycotting Reason Details <span className="text-red-600">*</span>
          </label>
          <textarea
